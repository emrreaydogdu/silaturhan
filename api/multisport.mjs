  ...
  <body class="multisport-page">
    ...
    <div class="site-header-shell">
      <header class="site-header">
        ...
        <nav class="desktop-nav" aria-label="Ana menü"><a href="/#hizmetler">Hizmetler</a><a href="/#yaklasim">Yaklaşımımız</a><a href="/uzm-fzt-silasu-arikan">Uzmanlık</a><a href="/multisport" aria-current="page">MultiSport</a><a href="/#iletisim">İletişim</a></nav>
        ...
        <nav class="mobile-menu" aria-label="Mobil menü"><a href="/#hizmetler">Hizmetler <span aria-hidden="true">↗</span></a><a href="/#yaklasim">Yaklaşımımız <span aria-hidden="true">↗</span></a><a href="/uzm-fzt-silasu-arikan">Uzmanlık <span aria-hidden="true">↗</span></a><a href="/multisport" aria-current="page">MultiSport <span aria-hidden="true">↗</span></a><a href="/#iletisim">İletişim <span aria-hidden="true">↗</span></a><button class="mobile-menu-cta" type="button" data-contact-trigger>Randevu oluştur <span aria-hidden="true">↗</span></button></nav>
      </header>
    </div>
