...
<html lang="tr">
  ...
  <body>
    <main class="doctor-page">
      ...
      <section class="profile-hero" aria-labelledby="tilbe-title"><div class="profile-hero-copy"><p class="eyebrow"><span></span> ${category}</p><h1 id="tilbe-title">${prefix}<br/><em>${name}</em></h1><p>${shortBio}</p><div class="profile-actions"><a class="button primary" href="/?randevu=1">Randevu oluştur ${arrow}</a></div><div class="profile-facts"><div class="profile-fact-card"><div class="profile-fact-icon" aria-hidden="true"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><polyline points="16 11 18 13 22 9"/></svg></div><div class="profile-fact-content"><strong>1:1 Seans</strong><small>Kişiye Özel Değerlendirme</small></div></div><div class="profile-fact-card"><div class="profile-fact-icon" aria-hidden="true"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 12h-4l-3 9L9 3l-3 9H2"/></svg></div><div class="profile-fact-content"><strong>Bütüncül Yaklaşım</strong><small>Hareket ve Fonksiyon</small></div></div><div class="profile-fact-card"><div class="profile-fact-icon" aria-hidden="true"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"/><circle cx="12" cy="10" r="3"/></svg></div><div class="profile-fact-content"><strong>İstanbul · Maltepe</strong><small>Klinik & Stüdyo</small></div></div></div></div><div class="profile-portrait"><img src="${image}" alt="Fizyoterapist Tilbe Meriç" /><div class="portrait-overlay"></div><span>${prefix}</span></div></section>
