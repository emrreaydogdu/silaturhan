...
<html lang="tr">
  ...
  <body>
    <main class="doctor-page">
      ...
      <section class="interests-section" id="uzmanlik"><div><p class="eyebrow light"><span></span> Uzmanlık alanları</p><h2>Hareketi<br/><em>güçlendiren</em> seanslar.</h2></div><div class="interest-list"><span>✓ Osteopatik değerlendirme</span><span>✓ Sporcu sağlığı ve fonksiyonel egzersiz</span><span>✓ Core ve stabilizasyon egzersizleri</span><span>✓ Ortopedik rehabilitasyon</span><span>✓ Nörolojik rehabilitasyon</span><span>✓ Geriatrik (yaşlı) rehabilitasyon</span><span>✓ Denge rehabilitasyonu</span><span>✓ Klinik pilates</span><span>✓ Manuel terapi yaklaşımları</span><span>✓ Kinezyolojik bantlama</span></div></section>
